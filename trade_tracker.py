...
def add_trade(signal):
    try:
        ...
        trade = {
            ...
            "strategy_name": signal.get("strategy_name") or signal.get("setup_type"),
            "session": (signal.get("expert_session") or {}).get("session"),
            "entry_reason": signal.get("signal_quality_reason"),
            "smart_money_setup": signal.get("smart_money_setup"),
            "atr": signal.get("atr"),
            "atr_ratio": signal.get("atr_ratio"),
            "volume_ratio": signal.get("volume_ratio"),
            "risk_score": signal.get("risk_score"),
            "risk_level": signal.get("risk_level"),
            "quality_checklist_score": signal.get("quality_checklist_score"),
