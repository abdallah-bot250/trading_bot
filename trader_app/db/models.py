...
class User(Base, TimestampMixin):
    ...
    spot_auto_trade_enabled = Column(Integer, nullable=False, default=0)
    futures_auto_trade_enabled = Column(Integer, nullable=False, default=0)
    max_trade_size = Column(Float, nullable=False, default=10)
    stop_loss_required = Column(Integer, nullable=False, default=1)
